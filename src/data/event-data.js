const event_data = [
  {
    ...
    title: "مرحلة ما قبل التعلم",
    stage: 1,
    sm_desc:
      "ستتعرف فيها على الأساسيات والمفاهيم الرئيسية، مما يمهد الطريق لتعلم أعمق.",
    delay: "100",
    university: true,
    event_grid: true,
  },

  {
    ...
    stage: 2,
    sm_desc:
      "ستقوم ببناء أساس قوي في المهارات الأساسية، وهي خطوة حاسمة لنجاحك .",
    delay: "200",
    university: true,
    event_grid: true,
  },

  {
    ...
    title: "مرحلة التأهيل لسوق العمل",
    stage: 3,
    sm_desc:
      "ستتلقى التدريب العملي والنصائح اللازمة لتكون جاهزاً لمواجهة تحديات سوق العمل.",
    delay: "300",
    university: true,
    event_grid: true,
  },
